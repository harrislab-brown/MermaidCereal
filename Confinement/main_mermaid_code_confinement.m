...
nvec = 60;%% Vector of number of particles to run per trial
...
%% Potential parameters
        ...
        %repulsive
        %m=1.5*0.00087/2; %% magnet dipole strength for each foci point. Remeber this is the general ellipse code.
...
%% first mass ODE45 solver
        [t,th] = ode45(@(t,th) motion_nbod_confine(t,th,that,avec,mass_disk,I,m,f_0,R,l_c,mu_0,confinement_radius),[t0 tEnd1],initcon);
